...
// 职级专业新增编辑
const RankProfessionalForm = (props) => {
	...
	const initFormFields = [
		{
			...
			required: true,
			label: "职级专业",
			rules: [{ required: true, message: "请输入职级专业" }],
			field: <CusFormItemInput placeholder="职级专业" maxLength={100} />,
		},
		{
			name: "describe",
			required: false,
...
export default RankProfessionalForm;
